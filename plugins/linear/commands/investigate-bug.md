...
2. **Gather non-codebase context** - Gather any important non-codebase context such as related git commits and PRs, Sentry issues, Render backend logs, Supabase data, etc.
